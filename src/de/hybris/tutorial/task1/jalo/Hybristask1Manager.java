...
/**
 * This is the extension manager of the Hybristask1 extension.
 */
public class Hybristask1Manager extends GeneratedHybristask1Manager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Hybristask1Manager.class.getName());
	 ...
	 */
	public static Hybristask1Manager getInstance()
	{
		return (Hybristask1Manager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Hybristask1Constants.EXTENSIONNAME);
	}
	 ...
	 */
	public Hybristask1Manager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Hybristask1Manager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Hybristask1Manager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Hybristask1Manager called, current tenant: " + getTenant().getTenantID());
		}
	}
