 ...
 *  
 */
package de.hybris.tutorial.task2.jalo;
...
import de.hybris.tutorial.task2.constants.Hybristask2Constants;



/**
 * This is the extension manager of the Hybristask2 extension.
 */
public class Hybristask2Manager extends GeneratedHybristask2Manager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(Hybristask2Manager.class.getName());
	 ...
	 */
	public static Hybristask2Manager getInstance()
	{
		return (Hybristask2Manager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				Hybristask2Constants.EXTENSIONNAME);
	}
	 ...
	 */
	public Hybristask2Manager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of Hybristask2Manager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of Hybristask2Manager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of Hybristask2Manager called, current tenant: " + getTenant().getTenantID());
		}
	}
